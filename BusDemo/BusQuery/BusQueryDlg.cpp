...
BEGIN_MESSAGE_MAP(CBusQueryDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
END_MESSAGE_MAP()
...
void CBusQueryDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//显示。
HCURSOR CBusQueryDlg::OnQueryDragIcon()
{
